...
az spring app deploy --resource-group $AZ_RESOURCE_GROUP --service  $AZ_SPRING_APP_SERVICE --name $AZ_SPRING_APP_NAME --artifact-path target/foodbroker-0.0.1-SNAPSHOT.jar --disable-validation
